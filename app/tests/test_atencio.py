...
def test_atencio():
    ...
    if st.session_state.app_state_atencio == "instructions":
        ...
        # --- GUARDAR RESULTATS ---
        if (
            (st.session_state.game_over_atencio or
             st.session_state.level_atencio > NIVELL_FINAL)
